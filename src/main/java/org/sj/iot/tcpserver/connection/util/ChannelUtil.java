package org.sj.iot.tcpserver.connection.util;
...
public class ChannelUtil {
     ...
     * 获取通道所属设备的MAC地址
     */
    public static void getAllChannel(BiConsumer<String, Channel> func) {
        if (func != null) {
            Stream<Entry<String, Channel>> stream = cacheChannel.entrySet().parallelStream();
     ...
     * 获取所有Mac地址
     */
    public static void getAllMac(Consumer<String> func, Predicate<String>... filters) {
        if (func != null) {
            Stream<String> stream = cacheChannel.keySet().parallelStream();
            if (filters != null) {
